...
import {Sticker} from './ui/nodes/Sticker.tsx'
import {Arrow} from "./ui/nodes/Arrow.tsx";
            ...
            >
                {viewModel?.nodes?.map((node) => {
                    if (node.type === 'sticker') {
                        return <Sticker {...node} ref={nodeRef} key={node.id}/>
                    }
                    if (node.type === 'arrow') {
                        return <Arrow {...node} ref={nodeRef} key={node.id}/>
                    }
                })}
